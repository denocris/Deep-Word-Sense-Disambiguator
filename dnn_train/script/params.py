...
# ------------------------------------
# 1 = True, 0 = False
POS_TAG = int(str(sys.argv[9]))


# ------------------------------------
# ------------- TRAINING PARAMS ------------
# ------------------------------------
LEARNING_RATE = 0.0005 #0.001 sarà #doveè 0.005 #è_e 0.005 #ho_o ha_a 0.001 #0.005
DECAY_LEARNING_RATE_ACTIVE = True
# For LSTM0
FORGET_BIAS = 1.0
# For LSTM0
DROPOUT_RATE = 0.8 #0.5
# For LSTM it refers to the size ofthe Cell, for CNN model instead are the FC layers
...
#----> sys.argv[7] is placed above!
AMBIGUITY = str(sys.argv[8])
#----> sys.argv[9] is placed above!
# ------------------------------------
# ------- TRAIN & VALID PATH ---------
# ------------------------------------
