...
# Usage
# $:python3 main.py 'model-name' 'checkpoint-path' 'train-data-path' 'valid-data-path' 'vocab-path' 'num-words-path' 'training size' 'num_layers'
...
if __name__ == "__main__":
    ...
    GLOVE_PATH = '../../glove-ita/glove_WIKI'
